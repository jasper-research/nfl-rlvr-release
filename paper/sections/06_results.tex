...
the betting market. On the held-out 2024 season the direct model reaches an expected calibration error of
$0.029$, against the market's $0.027$ and the untrained model's $0.057$. Its maximum-bin error, $0.060$,
is below the market's $0.082$, and its reliability curve lies on the diagonal where the untrained model's
does not (\cref{fig:reliability}). Its Brier score of $0.144$ improves on the untrained $0.206$ and trails
the market's $0.136$ (\cref{tab:main}). The masked chain-of-thought model is as well calibrated, at an
expected calibration error of $0.030$, with a slightly higher Brier score of $0.152$.
...
expected calibration error is $0.029$ against the teacher's $0.044$, and its maximum-bin error $0.060$
