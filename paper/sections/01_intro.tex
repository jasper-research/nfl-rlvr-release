...
\input{sections/F1_principle.tex}
...
expected calibration error (ECE) of $0.029$ against the market's $0.027$, and it is better calibrated
than a zero-shot frontier model, with no human labels and no access to the market. On the Brier score it
...
at which the stated probability does not follow from it from $22.4\%$ to $4.4\%$, at a small cost in
sharpness.
